...
export default function Home() {
  return (
    <>
      <Head>
        <title>Dispensa - Your dynamic kitchen assistant</title>
        <meta
          property="og:title"
          content="Dispensa - Your dynamic kitchen assistant"
          key="title"
        />
      </Head>
      <div className="flex h-screen flex-col justify-center py-12 sm:px-6 lg:px-8 bg-dispensa-off-white">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Ready to join Dispensa?{" "}
            <Link
              href="/signup"
              className="font-medium text-dispensa-orange hover:opacity-75"
            >
              Sign up
            </Link>
          </p>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-dispensa-white py-8 px-4 border-3 border-black sm:rounded-md sm:px-10">
            ...
            <div className="mt-6">
              ...
              {/* Can use bottom when / if using next auth or similar */}
